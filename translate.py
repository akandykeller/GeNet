...
tf.app.flags.DEFINE_string("ckpt_file", "None", "Checkpoint file to load")
...
def create_model(session, forward_only):
  ...
  if FLAGS.ckpt_file != 'None':
    model_checkpoint_path = FLAGS.train_dir + FLAGS.ckpt_file

  if ckpt and gfile.Exists(model_checkpoint_path):
